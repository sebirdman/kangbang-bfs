...
#define SLEVEL  5 // 1 = normal, 2 = extreme, 3 = 1.92, 4 = 1.92X, 5 = battsaver
...
{ 230400, PLL_3, 5, 1, 192000, 850, VDD_RAW(850) },
...
#else 
	for (vdd_mv = 750; vdd_mv <= 1475; vdd_mv += 25)
#endif
